  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-b border-slate-800/80 flex items-center justify-between">
        <Link href="/business/crm" className="flex items-center gap-3 overflow-hidden">
          ...
          {!isCollapsed && (
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[10px] text-blue-400 font-semibold uppercase tracking-widest mt-0.5">Business OS</span>
            </div>
          )}
        </Link>
